# [NoCopyTest] Exact copy of Remove_periodicity_2D_NS_orlanski.py with ONLY the
# [NoCopyTest] ghost-column copies after the Orlanski update (phi[b+1] = phi[b],
# [NoCopyTest] phi[b+2] = phi[b+1]) removed, to test whether that step changes the run.
import numpy as np
        ...
        for j in range(nj):
            ...
            if rx < 0.0: # inflow
                ...
                if nudging_mode == 1:
                    ...
                    # phi[k, j, b_obc+1] = phi[k, j, b_obc]  # [NoCopyTest] ghost copy removed
                    # phi[k, j, b_obc+2] = phi[k, j, b_obc+1]  # [NoCopyTest] ghost copy removed
                else:
