# [Copy3-Test] Copy of Remove_periodicity_2D_NS_orlanski.py where the ghost-column
# [Copy3-Test] copies after the Orlanski update are changed to: copy b+1, b+2 and b+3.
import numpy as np
        ...
        for j in range(nj):
            ...
            if rx < 0.0: # inflow
                ...
                if nudging_mode == 1:
                    ...
                    phi[k, j, b_obc+3] = phi[k, j, b_obc+2]  # [Copy3-Test] additional b+3 ghost copy
                else:
