# [Copy2-Test] Copy of Remove_periodicity_2D_NS_orlanski.py where the ghost-column
# [Copy2-Test] copies after the Orlanski update are changed to: copy b+1 and b+2 (identical to the regular scheme).
import numpy as np
