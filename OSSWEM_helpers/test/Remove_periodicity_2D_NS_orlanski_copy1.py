# [Copy1-Test] Copy of Remove_periodicity_2D_NS_orlanski.py where the ghost-column
# [Copy1-Test] copies after the Orlanski update are changed to: copy b+1 only.
import numpy as np
        ...
        for j in range(nj):
            ...
            if rx < 0.0: # inflow
                ...
                if nudging_mode == 1:
                    ...
                    # phi[k, j, b_obc+2] = phi[k, j, b_obc+1]  # [Copy1-Test] b+2 ghost copy removed (only b+1 copied)
                else:
